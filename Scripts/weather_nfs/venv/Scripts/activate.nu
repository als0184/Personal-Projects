...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\austin\PycharmProjects\weather_nfs\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\austin\PycharmProjects\weather_nfs\venv\Scripts\deactivate.nu'
